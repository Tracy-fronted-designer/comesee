...
class Service extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <h1 className={styles.h1}>會員服務條款</h1>
        <p className={styles.p}>
          非常歡迎您光臨ComeSee看戲網站（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
        </p>
        <div>
          <h4 className={styles.h4}>一、會員服務條款</h4>
        ...
        <div>
          <h4 className={styles.h4}>二、隱私權保護</h4>
          <p className={styles.p}>
            尊重並依據本網站「隱私權保護聲明」保護您的隱私(請參閱「隱私權保護聲明」條款)。
          </p>
        </div>
        <div>
          <h4 className={styles.h4}>三、會員</h4>
          <ol className={styles.ol}>
            <li>
        ...
        <div>
          <h4 className={styles.h4}>四、會員登錄資料</h4>
          <ol className={styles.ol}>
        ...
        <div>
          <h4 className={styles.h4}>五、使用行為</h4>
          <ol className={styles.ol}>
            <li>
        ...
        <div>
          <h4 className={styles.h4}>六、本公司專有權利</h4>
          <ol className={styles.ol}>
            <li>
        ...
        <div>
          <h4 className={styles.h4}>九、修改權</h4>
          <ol className={styles.ol}>
            <li>
        ...
        <div>
          <h4 className={styles.h4}>十、智慧財產權的保護</h4>
          <ol className={styles.ol}>
            <li>
        ...
        <div>
          <h4 className={styles.h4}>十一、其他規定</h4>
          <ol className={styles.ol}>
        ...
        <div>
          <h4 className={styles.h4}>十二、會員身份終止與本公司通知之義務：</h4>
          <ol className={styles.ol}>
